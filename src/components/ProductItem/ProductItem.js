            ...
            <div className="p-4">  
                <div className="rounded-3xl overflow-hidden shadow-lg font-roboto space-y-1 flex-stretch flex-col pb-7 hover:bg-gray-50 transition-colors duration-700 cursor-pointer w-60 md:w-72">
                    ...
                    <div className="px-9 py-4 space-y-2 flex flex-col items-start">
                        <div className="font-normal text-sm md:text-lg text-gray-800 capitalize">{props.title}</div>
                        <div className='font-light text-left text-gray-400 pt-1 md:pt-0 text-xs md:text-sm overflow-hidden' style={{flex: '0 1 22px'}}>{props.description}</div>
                    </div>
