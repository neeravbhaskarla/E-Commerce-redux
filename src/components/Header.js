...
const Header=({cart, user})=>{
    ...
    return (
        <nav className='bg-black md:h-14 flex justify-between items-center font-sans flex-col md:flex-row pb-3 md:pb-0'>
            ...
            <div className='flex flex-col md:flex-row flex-end md:space-x-7 space-x-3 transition-color mr-3 items-center'>
                ...
                <div className="flex flex-row space-x-4 mt-3 md:mt-0">
